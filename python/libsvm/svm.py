...
__all__ = ['libsvm', 'svm_problem', 'svm_parameter',
           ...
           'SIGMOID', 'c_double', 'svm_model', 'SMO', 'CD_SMO', 'HYBRID', 'TCSMO']
...
class svm_parameter(Structure):
	_names = ["svm_type", "kernel_type", "solver_type", "degree", "gamma", "coef0",
			"cache_size", "eps", "C", "nr_weight", "weight_label", "weight",
			"nu", "p", "shrinking", "probability"]
	_types = [c_int, c_int, c_int, c_int, c_double, c_double,
